...
class Claue_Elementor_Member_Widget extends \Elementor\Widget_Base {
	...
	public function create_shortcode() {
        ...
        return '[claue_addons_member'.$args_row.']';
